...
<div class="grid-view">
    ...
    <div class="grid-item">
        <a href="#whale">
            <img src="./img/variants/whale.png">
            Whale
        </a>
    </div>
    <div class="grid-item">
    ...
    <div class="grid-item">
        <a href="#magenta">
            <img src="./img/variants/magenta.png">
            Magenta
        </a>
    </div>    
    <div class="grid-item">
    ...
    <div class="grid-item">
        <a href="#demiromantic">
            <img src="./img/variants/demiromantic.png">
            Demiromantic
        </a>
    </div>
    <div class="grid-item">
